...
#这个库的安装，需要配套一个软件使用，在设置里要手动设置软件的接口
#之后代码适配的特定版本 pip install moviepy==1.0.0，更新之后语法有变化；
#使用的问题主要出现在繁杂的库上，库的版本，型号，真假，需要校验
#
import wave, audioop
...
def add_audio(video, mp3, output='out.mp4'): # 将背景音乐添加到视频中
    ...
    volume = 'ffmpeg -i BGM.mp3 -vcodec copy -af "volume=-15dB" BGM_volume.mp3'
